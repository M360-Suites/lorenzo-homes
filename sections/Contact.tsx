...
export default function Contact() {
  ...
  const inputCls =
    "font-body text-[0.95rem] py-3 px-[14px] border border-stone-line rounded-[2px] bg-paper text-ink font-medium outline-none transition-all focus:border-brass focus:ring-2 focus:ring-brass/20 w-full";
  const labelCls =
    "flex flex-col gap-[6px] text-[0.82rem] font-bold text-ink-soft mb-[18px]";

  return (
    <section id="contact" className="py-[110px] bg-paper">
      <div className="wrap grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-16">
        {/* Info */}
        <div ref={infoRef} className="reveal">
          <p className="eyebrow">Get In Touch</p>
          <h2 className="text-[clamp(1.7rem,2.8vw,2.2rem)] mb-[0.5em]">
        ...
        <div ref={formRef} className="reveal">
          <form
            ...
            className="bg-stone p-[38px] rounded-[2px]"
            noValidate
          >
            ...
            <button
              ...
              className="btn btn-solid btn-full mt-1"
            >
