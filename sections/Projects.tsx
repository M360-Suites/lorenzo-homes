...
const COMPLETED = {
  commercial: [
    ...
    {
      name: "Ultra-Modern Mall · 2,950 sqm GLA, 4 floors",
      loc: "Orchid Road, Lekki",
    },
    {
      name: "Ultra-Modern Shopping Mall · 3,300 sqm GLA",
      loc: "Lekki Phase 1",
    },
  ],
  industrial: [
    ...
    <section id="projects" className="py-[110px] bg-ink text-white">
      <div className="wrap">
        <div className="section-head mb-10">
          ...
          <h2 className="text-white text-[clamp(1.9rem,3vw,2.5rem)]">
            Past delivery. Present momentum.
          </h2>
        </div>
        ...
        {tab === "completed" && (
          <div className="animate-fadeUp">
              ...
              {[
                {
                  heading: "Commercial",
                  count: 7,
                  items: COMPLETED.commercial,
                },
                {
                  heading: "Industrial",
                  count: 5,
                  items: COMPLETED.industrial,
                },
                {
                  heading: "Residential",
                  count: 4,
                  items: COMPLETED.residential,
                },
              ].map((col) => (
                <div key={col.heading}>
                  <h3 className="text-[1.05rem] border-b border-white/18 pb-[14px] mb-[18px]">
                    {col.heading}{" "}
                    <span className="text-brass-light font-normal">
                      · {col.count}
                    </span>
                  </h3>
                  <ul className="list-none m-0 p-0 flex flex-col gap-4">
                    {col.items.map((item) => (
                      <li key={item.name} className="flex flex-col gap-[2px]">
                        ...
                        <small className="text-[0.8rem] text-white/55">
                          {item.loc}
                        </small>
                      </li>
                    ))}
            ...
            <p className="mt-[46px] text-[0.88rem] text-white/55 max-w-[640px] border-t border-white/12 pt-6 mb-0">
              Full details and pictures of completed projects are available on
              request. Site inspections can be arranged at short notice.
            </p>
          </div>
        )}
        ...
        {tab === "ongoing" && (
          <div className="animate-fadeUp grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-[54px] items-start">
            ...
            <div>
              ...
              <h3 className="font-display text-[1.8rem] mb-[0.5em]">
                Orchid Road, Lekki
              </h3>
              <p className="text-white/72">
                A 3,100 sqm gross lettable, mixed-use commercial plaza rising on
                2,350 sqm of land along Orchid Road, Lekki — built for retail
                flagships, showrooms and office suites in one of Lagos's
              ...
              <div className="flex gap-[14px] my-[22px] flex-wrap">
                {[
                  ...
                  <div
                    key={c.label}
                    className="bg-white/[0.06] border border-white/12 p-[14px_18px] rounded-[2px] min-w-[120px]"
                  >
                    <strong className="block font-display text-[1.3rem] text-white">
                      {c.val}
                    </strong>
                    <span className="text-[0.76rem] text-white/55">
                      {c.label}
                    </span>
                  </div>
                ))}
